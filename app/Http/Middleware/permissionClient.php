...
class permissionClient
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if($clientPermission->permission==2 and $request->getRequestUri()=='/frontoffice/documents/Controlopragas')
        {
            return redirect('/home');
        }
        if($clientPermission->permission==3 and $request->getRequestUri()=='/frontoffice/documents/HACCP')
        {
            return redirect('/home');
        }
