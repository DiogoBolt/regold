    ...
    <section >
                        <div class="container index-box">
                            ...
                            @endif
                                ...
                                @else
                                    <a class="disabled" title="Produtos" href="/frontoffice/categories"><img class="img-responsive" src="{{ URL::to('/') }}/img/index/Produtos.png">PRODUTOS</a>
                                @endif

                                @if($permissionsStaff[6])
                                ...
                                @else
                                    <a class="disabled" title="Encomendas" href="/frontoffice/orders">
                                        <img class="img-responsive" src="{{ URL::to('/') }}/img/index/Encomendas.png">ENCOMENDAS
                                    </a>
                                @endif
                                @if($permissionsStaff[4])
                                ...
                                @else
                                    <a class="disabled" title="Documentos Registos" href="/frontoffice/documents/Registos"><img class="img-responsive" src="{{ URL::to('/') }}/img/index/Registos.png">REGISTOS</a>
                                @endif
                                @if($permissionsStaff[2])
                                ...
                                @else
                                    <a class="disabled" title="Documentos Contabilisticos" href="/frontoffice/documents/Contabilistico"><img class="img-responsive" src="{{ URL::to('/') }}/img/index/DocumentosCont.png">DOCUMENTOS CONTABILISTICOS</a>
                                @endif
                        </div>
    </section>
