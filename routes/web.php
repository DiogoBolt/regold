...
Route::group(['middleware' => ['backoffice']], function () {
    ...
    Route::post('/sendDate', 'ScheduleController@sendDate');
  ...
  /*  Route::get('/clients/regolfood', 'ClientController@indexRegolfood');
    ...
    Route::delete('/clients/deletereceipt','ClientController@deleteReceipt');
    ...
    Route::get('/clientsOrder/{pack}', 'ClientController@ordersByPack');
    //pedro                             
